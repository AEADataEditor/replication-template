...
#### summarize-sivacor (SIVACOR Part B Generator)

**When to use**: A submitted repository was generated by SIVACOR and includes a `tro/` directory (openICPSR deposits may ship it as part of the deposit; otherwise `9-download-sivacor` fetches it)
